...
class MediumFirewallWidgetConfigurationActivity: AppCompatActivity() {
        ...
        RevcelMaterialTheme {
            ProjectWidgetConfigurationView(
                ...
                onDone = {
                    ...
                    MediumFirewallWidgetReceiver().onProjectSelected(applicationContext, appWidgetId, selectedProject, isSubscribed)
